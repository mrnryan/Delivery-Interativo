...
HTML;
	...
	for ($i = 0; $i < $linhas; $i++) {
		...
		if (empty($arquivo) || $arquivo === 'sem-foto.jpg') {
    $tumb_arquivo = 'sem-foto.png';
    $arquivo = 'sem-foto.png'; // ← agora o link também aponta para a imagem real
} else {
    ...
    } elseif ($ext == 'xlsx' || $ext == 'xlsm' || $ext == 'xls') {
        $tumb_arquivo = 'excel.png';
    } elseif ($ext == 'xml') {
        $tumb_arquivo = 'xml.png';
    } else {
        $tumb_arquivo = $arquivo; // imagem real
    }
}
