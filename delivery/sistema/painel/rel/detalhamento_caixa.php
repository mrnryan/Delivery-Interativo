...
<body>
	...
	if ($marca_dagua == 'Sim') { ?>
		<img class="marca" src="<?php echo $url_sistema ?>sistema/img/foto-painel-full1.jpg">
	<?php } ?>
			...
			<table style="width: 100%; border: 0px solid #ccc;">
				<tr>
					<td style="border: 1px; solid #000; width: 40%; text-align: left;">
						<img style="margin-top: 2px; margin-left: 7px;" id="imag" src="<?php echo $url_sistema ?>sistema/img/foto-painel-full1.jpg" width="110px">
					</td>
