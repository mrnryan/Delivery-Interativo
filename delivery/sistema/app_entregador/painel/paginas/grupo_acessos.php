...
//totalizar páginas
$query2 = $pdo->query("SELECT * from grupo_acessos where nome like '%$buscar%' order by id desc");
...
<div id="pages_maincontent" style="background: #FFF; ">
	...
	<div class="loginform" style="margin-top: 10px">
		<form method="post">
		<input  type="text" name="buscar" id="buscar" value="<?php echo $buscar ?>" class="form_input required" placeholder="Buscar Grupos" style="background: transparent !important; width:80%; float:left" />
	...
	<div class="page_single layout_fullwidth_padding"> 
		...
		<ul class="posts2" id="listar">
			<?php 
			$query = $pdo->query("SELECT * from grupo_acessos where nome like '%$buscar%'  order by id desc LIMIT $limite, $itens_pag");
