...
<div id="pages_maincontent" style="background: #FFF; ">
	...
	<div class="loginform" style="margin-top: 10px">
		<form method="post">
		<input  type="text" name="buscar" id="buscar" value="<?php echo $buscar ?>" class="form_input required" placeholder="Buscar Frequências" style="background: transparent !important; width:80%; float:left" />
	...
	$dias = $res[$i]['dias'];
					...
					<div class="post_category textos_list">{$frequencia}</div>				
					<p>Dias: {$dias}%</p>					
					</div>
					...
					<a onclick="excluir_reg('{$id}', '{$frequencia}')" style="width: 45px; height:45px; background: #d4412a" href="#"><img src="images/icons/white/trash.png" alt="" title="" style="margin-top:15px"/></a>		
					<a onclick="editar('{$id}','{$frequencia}','{$dias}')" style="width: 45px; height:45px; background: #3c6cb5" href="#" class="action1"><img src="images/icons/white/edit.png" alt="" title="" style="margin-top:15px"/></a>
			...
			<div class="contactform">
				<form id="form" method="post">
					...
					<div style="width:48%; float:left">
						...
						<input type="text" name="frequencia" id="frequencia" value="" class="form_input"  style="height:25px;"/>
					</div>

					<div style="width:48%; float:right">
						<label class="labels_form">Dias</label>
						<input type="number" name="dias" id="dias" value="" class="form_input" style="height:25px;"/>
					</div>
